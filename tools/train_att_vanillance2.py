...
from lib.predictornce1 import AttVanillaPredictorV2
...
def main(args):
    ...
    for epoch in range(CONFIG['EPOCH']):
        ...
        save_path = '/home_data/wj/ref_nms/output/refnce_t0004t1006_{}_{}.pth'.format(dataset_splitby, epoch + 1)
    ...
    save_path = '/home_data/wj/ref_nms/output/refnce_t0004t1006_{}_b.pth'.format(dataset_splitby)
    ...
    json_pth = '/home_data/wj/ref_nms/output/refnce_t0004t1006_{}.json'.format(dataset_splitby)
