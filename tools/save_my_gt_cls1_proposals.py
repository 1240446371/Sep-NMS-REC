   ...
   # device = torch.device('cuda', gpu_id)
    ...
    for exp_id,lfeats, pos_feat, sent_feat, bert_feats,pos_box, pos_score, cls_num_list in tqdm_loader:
        ...
        for cls_gt, cls_ref, cls_pos_box, cls_pos_score in zip(gt_score_list,rank_score_list,pos_box_list, pos_score_list):
            ...
            for box0, score0 in zip(cls_pos_box, cls_gt):
                proposals_gt.append({'score': score0.item(), 'box': box0.tolist(), 'cls_idx': cls_idx})
            
            for box1, score1 in zip(cls_pos_box, cls_pos_score):
    ...
    return (exp_to_proposals_gt,exp_to_proposals_cls)
...
def main(args):
    ...
    save_path0 = '/data1/wj/ref_nms/cache/my_qkad_gtall_proposals_{}_{}.pkl'.format(args.m, args.dataset)
    save_path1 = '/data1/wj/ref_nms/cache/my_qkad_clsall_proposals_{}_{}.pkl'.format(args.m, args.dataset)
