...
from lib.my_matt_predictor import AttVanillaPredictorV2
...
def compute_loss(predictor, criterion_ref, criterion_gt,device, enable_grad, roi_feats, roi_labels,labels_gt_neg, word_feats, sent_len,sent_feats,lfeats):
    with torch.autograd.set_grad_enabled(enable_grad):
        ...
        loss_ref = criterion_ref(ref_scores, roi_labels)
...
def main(args):
    ...
    save_path = '/home_data/wj/ref_nms/output/my_matt_ad_{}_{}_b.pth'.format(dataset_splitby,tid)
    ...
    with open('/home_data/wj/ref_nms/output/my_matt_ad_{}_{}.json'.format(args.dataset,tid), 'w') as f:
