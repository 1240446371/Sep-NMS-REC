...
def rank_proposals(position, gpu_id, tid, refdb_path, split, m,dataset_splitby ):
   ...
   # device = torch.device('cuda', gpu_id)
    ...
    for exp_id,pos_box, pos_score, pos_feat, sent_len, bert_token_feats,bert_sent_feats, lfeats, cls_num_list in tqdm_loader:
        ...
        for box2, score2 in zip(pos_box, gt_score):
...
def main(args):
    ...
    save_path0 = '/data1/wj/ref_nms/cache/my_Sigad_gtall_bertall_proposals_{}_{}.pkl'.format(args.m, args.dataset)
    #save_path1 = '/data1/wj/ref_nms/cache/my_Sigad_ref_bertall_proposals_{}_{}.pkl'.format(args.m, args.dataset)
