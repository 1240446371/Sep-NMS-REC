...
def main(args):
    ...
    save_path0 = '/data1/wj/ref_nms/cache/my_sipsepqkad_gt_proposals_{}_{}.pkl'.format(args.m, args.dataset)
    save_path1 = '/data1/wj/ref_nms/cache/my_sipsepqkad_ref_proposals_{}_{}.pkl'.format(args.m, args.dataset)
