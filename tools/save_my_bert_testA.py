   ...
   # device = torch.device('cuda', gpu_id)
    ...
    for exp_id,pos_box, pos_score, pos_feat, sent_len, bert_token_feats,bert_sent_feats, lfeats, cls_num_list in tqdm_loader:
        ...
        for cls_gt1,cls_pos_box, cls_pos_score in zip(gt_score_list,pos_box_list, pos_score_list):
            ...
            final_score_gt1 = (cls_gt_pos)**(3) * (cls_pos_score1)
...
def main(args):
    ...
    save_path0 = '/data1/wj/ref_nms/cache/my_Sigad_cls0.2_gtlfcls_testAproposals_{}_{}.pkl'.format(args.m, args.dataset)
    #save_path1 = '/data1/wj/ref_nms/cache/my_Sigad_cls0.3_gtcls_testAproposals_{}_{}.pkl'.format(args.m, args.dataset)
