...
def main(args):
    ...
    for epoch in range(CONFIG['EPOCH']):
        ...
        #save_path = '/home_data/wj/ref_nms/output/refnce_t002t103{}_{}.pth'.format(dataset_splitby, epoch + 1)
        save_path = '/data1/wj/ref_nms/output/refnce_t0004t1006{}_{}.pth'.format(dataset_splitby, epoch + 1)
    ...
    save_path = '/data1/wj/ref_nms/output/refnce_t0004t1006{}_b.pth'.format(dataset_splitby)
    ...
    with open('data1/wj/ref_nms/output/refnce_t0004t1006_{}.json'.format(dataset_splitby), 'w') as f:
