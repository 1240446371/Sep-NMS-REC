...
def main(args):
    ...
    #clipfeats_token = f.create_dataset('clipfeats_token', (num_dets, 512), dtype=np.float32)
        ...
        pro_save_path = '/data1/wj/ref_nms/cache/clipproposals_alltoken_{}_{}.pkl'.format( dataset_splitby,split)
