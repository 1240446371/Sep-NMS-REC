...
from lib.my_2bert_vanilla_utils import DetBoxDataset
...
def main(args):
    ...
    save_path = '/home_data/wj/ref_nms/output/my_2bert_attvanilla_{}_{}_b.pth'.format(dataset_splitby,tid)
    ...
    with open('/home_data/wj/ref_nms/output/my_2bert_attvanilla_{}_{}.json'.format(args.dataset,tid), 'w') as f:
