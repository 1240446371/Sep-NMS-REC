...
from lib.my_bertall_predictor import AttVanillanPredictorV2
...
def main(args):
    ...
    predictor = AttVanillanPredictorV2(att_dropout_p=CONFIG['ATT_DROPOUT_P'],
    ...
    save_path = '/home_data/wj/ref_nms/output/my_bertall_qkad_{}_{}_b.pth'.format(dataset_splitby,tid)
    ...
    with open('/home_data/wj/ref_nms/output/my_bertall_qkad_{}_{}.json'.format(args.dataset,tid), 'w') as f:
