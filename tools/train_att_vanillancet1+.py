...
from lib.vanilla_utilsncet1g import DetBoxDataset
from lib.predictorncet1 import AttVanillaPredictorV2
...
def compute_loss(predictor, criterion, device, enable_grad, roi_feats, gt_num,ctx_pos_num, neg_num, roi_labels, labels_gt_ctx, word_feats, sent_len):
    with torch.autograd.set_grad_enabled(enable_grad):
        ...
        score_gt_ctx,scores, *_ = predictor.forward(roi_feats, gt_num,ctx_pos_num, neg_num, packed_sent_feats)
...
def main(args):
    ...
    with open(refdb_path, 'r') as f:
        refdb = json.load(f)
    ctxdb_path =  "/data1/wj/ref_nms/cache/ybclip_ctxdb_ann_08senrefcoco+_unc.json"
    ...
    for epoch in range(CONFIG['EPOCH']):
        ...
        save_path = '/home_data/wj/ref_nms/output/ybclip_nce_t1006_{}_{}.pth'.format(dataset_splitby, epoch + 1)
    ...
    save_path = '/home_data/wj/ref_nms/output/ybclip_nce_t1006_{}_b.pth'.format(dataset_splitby)
    ...
    json_pth = '/home_data/wj/ref_nms/output/ybclip_nce_t1006_{}.json'.format(dataset_splitby)
