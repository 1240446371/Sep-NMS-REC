...
def rank_proposals(position, gpu_id, tid, refdb_path, split, m,dataset_splitby ):
   ...
   # device = torch.device('cuda', gpu_id)
    ...
    for exp_id,lfeats, pos_feat, sent_feats,sent_len, bert_feats,pos_box, pos_score, cls_num_list in tqdm_loader:
        ...
        with torch.no_grad():
            ...
            rank_score = predictor(pos_feat, sent_len,word_feats,bert_feats,lfeats)  # [1, n_box]
