...
#.397299999997, 'iscrowd': 0, 'image_id': 579382, 'bbox': [416.73, 78.27, 63.27, 447.12], 'category_id': 1, 'id': 201995}
        ...
        save_path1  = '/data1/wj/ref_nms/cache/clip_ctx_007seninfo{}.json'.format(dataset_splitby)
    ...
    # Save results
    save_path = '/data1/wj/ref_nms/cache/clip_ctxdb_ann_007sen{}.json'.format(dataset_splitby)
