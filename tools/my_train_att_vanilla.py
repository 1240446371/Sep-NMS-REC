...
def main(args):
    ...
    save_path = '/home_data/wj/ref_nms/output/my_addloss_att_vanilla_{}_{}_b.pth'.format(dataset_splitby,tid)
    ...
    with open('/home_data/wj/ref_nms/output/my_addloss_att_vanilla_{}_{}.json'.format(args.dataset,tid), 'w') as f:
