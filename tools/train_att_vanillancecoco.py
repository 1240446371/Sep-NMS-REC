...
def main(args):
    ...
    for epoch in range(CONFIG['EPOCH']):
        ...
        save_path = '/home_data/wj/ref_nms/output/refnce_2losst0005t1007_{}_{}.pth'.format(dataset_splitby, epoch + 1)
    ...
    save_path = '/home_data/wj/ref_nms/output/refnce_2losst0005t1007_{}_b.pth'.format(dataset_splitby)
    ...
    json_pth = '/home_data/wj/ref_nms/output/refnce_2losst0005t1007_{}.json'.format(dataset_splitby)
