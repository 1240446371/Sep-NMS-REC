...
def main(args):
    ...
    save_path0 = '/data1/wj/ref_nms/cache/my_Sigad_0.01gtcube_cls_testAproposals_{}_{}.pkl'.format(args.m, args.dataset)
    save_path1 = '/data1/wj/ref_nms/cache/my_Sigad_0.01gt23cls_testAproposals_{}_{}.pkl'.format(args.m, args.dataset)
