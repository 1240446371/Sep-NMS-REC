...
def main(args):
    ...
    save_path = '/home/wj/code/ref_nms/output/my_nce_att_vanilla_{}_{}_b.pth'.format(args.dataset,tid)
    ...
    with open('/home/wj/code/ref_nms/output/my_nce_att_vanilla_{}_{}.json'.format(args.dataset,tid), 'w') as f:
