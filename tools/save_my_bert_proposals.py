...
from lib.my_bert_vanilla_utils1 import DetEvalLoader
...
def rank_proposals(position, gpu_id, tid, refdb_path, split, m,dataset_splitby ):
   ...
   # device = torch.device('cuda', gpu_id)
    ...
    #model_path = "/home_data/wj/ref_nms/output/my_bert_attvanilla_refcoco+_unc_1031100427_b.pth"  #wrong
    #model_path = "/home_data/wj/ref_nms/output/my_bert_attvanilla_refcocog_umd_1115202529_b.pth"
    model_path = "/home_data/wj/ref_nms/output/my_bert_attvanilla_refcoco_unc_1121163601_b.pth"
    ...
    for exp_id, pos_box, pos_score,pos_feat,  token_len, bert_token_feats,bert_sent_feats, lfeats, cls_num_list in tqdm_loader:
        ...
        with torch.no_grad():
            ...
            rank_score = predictor(pos_feat, token_len,bert_token_feats,bert_sent_feats,lfeats)  # [1, n_box]
...
def main(args):
    ...
    save_path = '/data1/wj/ref_nms/cache/my_bert_proposals_{}_{}.pkl'.format(args.m, args.dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tid', type=str, default='1121163601')# coco+ 0112095046 0318182906
