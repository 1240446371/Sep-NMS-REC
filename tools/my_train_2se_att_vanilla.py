...
from lib.vanilla_utilsg import DetBoxDataset
...
def main(args):
    ...
    ref_params = list(predictor.att_fc.parameters()) + list(predictor.rank_fc.parameters()) \
                 + list(predictor.vis_a_fc.parameters()) + list(predictor.vis_r_fc.parameters()) + list(predictor.se1.parameters())+ list(predictor.se2.parameters())
    ...
    for epoch in range(CONFIG['EPOCH']):
        ...
        #save_path = '/home_data/wj/ref_nms/output/att_vanilla_ckpt_{}_{}.pth'.format(tid, epoch + 1)
    ...
    save_path = '/home_data/wj/ref_nms/output/my2se_att_vanilla_{}_b.pth'.format(tid)
    ...
    with open('/home_data/wj/ref_nms/output/my2se_att_vanilla_{}.json'.format(tid), 'w') as f:
