...
from lib.my_vanilla_utils1 import DetBoxDataset
...
def compute_loss(predictor, criterion, device, enable_grad, roi_feats, roi_labels,labels_gt_neg, word_feats, sent_len,sent_feats,lfeats):
    with torch.autograd.set_grad_enabled(enable_grad):
        ...
        ref_scores = predictor.forward(roi_feats, packed_sent_feats,sent_feats ,lfeats)  # max_ref_score, max_idx, cls_score, bbox_pred
...
def main(args):
    ...
    save_path = '/home_data/wj/ref_nms/output/my_sipqkad_gtctx{}_{}_b.pth'.format(args.dataset,tid)
    #save_path = '/home/wj/code/ref_nms/output/pos06att_vanilla_yb004_{}_{}_b.pth'.format(args.dataset,tid)
    #save_path = '/home/wj/code/ref_nms/output/my_sipqkad_gtctx{}_{}_b.pth'.format(args.dataset,tid)
    ...
    with open('/home_data/wj/ref_nms/output/my_sipqkad_gtctx{}_{}.json'.format(args.dataset,tid), 'w') as f:
