...
def rank_proposals(position, gpu_id, tid, refdb_path, split, m):
    ...
    #"/home_data/wj/ref_nms/output/refnce_t002t103refcoco_unc.json"
    #json_pth = "/home_data/wj/ref_nms/output/refnce_t0005t1007_refcoco_unc.json"
    #json_pth ="/data1/wj/ref_nms/output/refnce_t0004t1006_refcoco_unc.json"
    ...
    #model_path = "/home_data/wj/ref_nms/output/refnce_t0005t1007_refcoco_unc_b.pth"
    #model_path = "/data1/wj/ref_nms/output/refnce_t0004t1006refcoco_unc_b.pth"
    #model_path = "/home_data/wj/ref_nms/output/refnce_2losst0005t1007_refcoco_unc_b.pth"
    #model_path = "/home_data/wj/ref_nms/output/refnce_t1006_refcoco_unc_b.pth"
    model_path ="/home_data/wj/ref_nms/output/att_vanilla_refcoco+_1019213349_b.pth"
...
def main(args):
    ...
    #save_path = '/data1/wj/ref_nms/cache/refnce_t0005t1007proposals_{}_{}.pkl'.format(args.m, args.dataset)
    save_path = '/data1/wj/ref_nms/cache/refnce_t1006_proposals_{}_{}.pkl'.format(args.m, args.dataset)
