...
def rank_proposals(position, gpu_id, tid, refdb_path, split, m,dataset_splitby ):
   ...
   # device = torch.device('cuda', gpu_id)
    ...
    model_path = "/home_data/wj/ref_nms/output/my_sipqkad_gtctxrefcoco_1028162815_b.pth"
    ...
    for exp_id,lfeats, pos_feat, sent_feat, bert_feats,pos_box, pos_score, cls_num_list in tqdm_loader:
        ...
        with torch.no_grad():
            ...
            rank_score = predictor(pos_feat, packed_sent_feats,bert_feats,lfeats)  # [1, n_box]
...
def main(args):
    ...
    save_path = '/data1/wj/ref_nms/cache/my_qkad_gtctx_proposals_{}_{}.pkl'.format(args.m, args.dataset)
...
if __name__ == '__main__': 
    ...
    parser.add_argument('--tid', type=str, default='1028162815')# coco+ 0112095046 0318182906
