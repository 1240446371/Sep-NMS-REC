...
from utils.constants import EVAL_SPLITS_DICTval
...
def rank_proposals(position, gpu_id, tid, refdb_path, split, m,dataset_splitby ):
   ...
   # device = torch.device('cuda', gpu_id)
    ...
    model_path = "/home_data/wj/ref_nms/output/my_bertall_qkad_sigad_refcoco_unc_1113160151_b.pth"
    ...
    for exp_id,pos_box, pos_score, pos_feat, sent_len, bert_token_feats,bert_sent_feats, lfeats, cls_num_list in tqdm_loader:
        ...
        cls_idx = 0
        for cls_gt,cls_pos_box, cls_pos_score in zip(gt_score_list,pos_box_list, pos_score_list):
            ...
            final_score_gt1 = (cls_gt)**(1/3) * (cls_pos_score1)
            ...
            final_score_gt2 = (cls_gt)**(2/3) * (cls_pos_score1)
...
def main(args):
    ...
    eval_splits = EVAL_SPLITS_DICTval[dataset_splitby]
    ...
    save_path0 = '/data1/wj/ref_nms/cache/my_Sigad_0.01gtcube_cls_valproposals_{}_{}.pkl'.format(args.m, args.dataset)
    save_path1 = '/data1/wj/ref_nms/cache/my_Sigad_0.01gt23cls_valproposals_{}_{}.pkl'.format(args.m, args.dataset)
